    ...
    public partial class deleteCourse : Form
    {
        ...
        private void btn_delete_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                cmd.Connection = con;
                string deleteQuery = "delete from courses where CourseCode ='" + txt_courseCode.Text + "'";
                ...
                MessageBox.Show("Course successfully removed", " Success", MessageBoxButtons.OK, MessageBoxIcon.Information);
